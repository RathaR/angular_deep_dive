...
describe('injector', function () {
    ...
    it('loads transitively required modules of a module', function () {
        var module1 = angular.module('myModule', []);
        var module2 = angular.module('myOtherModule', ['myModule']);
    ...
    it('does not accept non-string as injection tokens', function () {
        var module = angular.module('myModule', []);
        module.constant('a', 1);
        var injector = createInjector(['myModule']);
    ...
    describe('annotate', function () {
        ...
        it('returns an empty array for a non-annotated 0-arg functions', function () {
            var injector = createInjector();
        ...
        it('skips comments from argument list when parsing', function () {
            var injector = createInjector();
        ...
        it('strips several comments from argument list when parsing', function () {
            var injector = createInjector([]);
        ...
        it('strips // comments from arrgument ist when parsing', function () {
            var injector = createInjector([]);
            var fn = function (a, //b
                               c) {
            };
        ...
        it('uses a prototype of the constructor when instantiating', function () {
            function BaseType() {
            }
    ...
    it('allow registering a provider and uses its $get', function () {
        var module = angular.module('myModule', []);
        module.provider('a', {
            $get: function () {
                return 42;
    ...
    it('notified the user about a circular dependency', function () {
        var module = angular.module('myModule', []);
        module.provider('a', {
            $get: function (b) {
            }
    ...
    it('allow injecting the $provide service to providers', function () {
        var module = angular.module('myModule', []);
    ...
    it('run blocks with the instance injector', function () {
        var module = angular.module('myModule', []);
    ...
    it('configure all modules before running any run blocks', function () {
        var module1 = angular.module('myModule', []);
        var result;
        var module2 = angular.module('myOtherModule', []);
    ...
    it('support returning a run block from a function module', function () {
        var result;
        var functionModule = function ($provide) {
            $provide.constant('a', 42);
            return function (a) {
    ...
    it('inject a factory function with instances', function () {
        var module = angular.module('myModule', []);
    ...
    it('does not make a values available to config block', function () {
        var module = angular.module('myModule', []);
        module.value('a', 42);
