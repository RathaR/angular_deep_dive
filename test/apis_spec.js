...
describe('apis', function () {
    ...
    describe('hasKey', function () {
        ...
        it('is not the same for different objects even the same value', function () {
            var obj1 = {a: 42};
            var obj2 = {a: 42};
        ...
        it('support a function $$hashKey', function () {
    ...
    describe('HashMap', function () {
        ...
        it('supports put and get of object with hashKey semantics', function () {
            var map = new HashMap();
            var obj = {};
        ...
        it('return value from remove', function () {
            var map = new HashMap();
            map.put(42, 'fourty two');
